...
function twoslasher(code, extension, options) {
  ...
  var system = useFS ? vfs.createSystem(vfs$1) : vfs.createFSBackedSystem(vfs$1, getRoot(), ts, options.tsLibDirectory);
  ...
  var _loop4 = function _loop4() {
    ...
    var lineOffset = codeLines.findIndex(function (line) {
      if (line.includes("// @filename: ")) {
        var fileName = line.split("// @filename: ")[1].trim();
